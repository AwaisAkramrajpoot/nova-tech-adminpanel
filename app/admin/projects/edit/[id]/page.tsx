          ...
          <main className="flex-1 overflow-auto">
            <div className="p-6 lg:p-8">
              <div className="mb-8">
                ...
                <p className="text-muted-foreground mt-2">The project youre looking for doesnt exist or you dot have permission to edit it.</p>
              </div>
            </div>
          </main>
        </div>
        ...
        <main className="flex-1 overflow-auto">
          <div className="p-6 lg:p-8">
            ...
            <div className="mb-8">
              ...
              <p className="text-muted-foreground mt-2">Update project details and settings</p>
            </div>
